...
class WhereClauseVisitorTest {
  ...
  void testVisitBoundEquality() {
    ...
    UnionFind.UnionElement elt = visitor.getUnionFind().find("attr1");
    assertEquals(
        15.0, elt.getEqualityConstraint(), "Equality constraint for attr1 should be set to 15.0.");
  }
  ...
  void testComplexConstraints() {
    ...
    assertEquals(
        7.0,
        visitor.getEqualityConstraint("attr3"),
        "Equality constraint for attr3 should be 7.0.");
  }
}

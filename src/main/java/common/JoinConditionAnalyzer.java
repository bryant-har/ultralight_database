...
public class JoinConditionAnalyzer extends ExpressionVisitorAdapter {
    ...
    public JoinConditionAnalyzer(String leftTableName, String rightTableName) {
        ...
        logger.info("Creating analyzer for left table '{}' and right table '{}'",
    ...
    public void visit(EqualsTo expr) {
        ...
        logger.info("Analyzing equality condition: {}.{} = {}.{}",
                leftTable, leftCol.getColumnName(),
                rightTable, rightCol.getColumnName());
    ...
    private void logColumnDetails(String side, Column col) {
        ...
        logger.debug("{} column details - Table: {}, Alias: {}, Column: {}",
                side, tableName, alias, col.getColumnName());
    }
    ...
    private boolean isMatchingPair(String table1, String table2) {
        ...
        logger.debug("Comparing tables: {}={} and {}={} : {}",
                t1, left, t2, right, matches);
        return matches;
    }

    public List<Column> getLeftSortColumns() {
        logger.info("Returning {} left columns", leftColumns.size());
        leftColumns.forEach(col -> logger.debug("Left column: {}.{}",
                normalizeTableName(col.getTable()),
                col.getColumnName()));
        return leftColumns;
    }
    ...
    public List<Column> getRightSortColumns() {
        ...
        rightColumns.forEach(col -> logger.debug("Right column: {}.{}",
                normalizeTableName(col.getTable()),
                col.getColumnName()));
        return rightColumns;
    }
    ...
    public boolean isValidEquiJoin() {
        ...
        logger.info("Checking equijoin validity: {} left columns, {} right columns, valid: {}",
                leftColumns.size(), rightColumns.size(), isValid);
        return isValid;
    }
}
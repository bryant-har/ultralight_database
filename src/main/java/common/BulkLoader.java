...
public class BulkLoader {
    ...
    private void writeSortedRelation(String relationName) {
        String sortedFileName = "src/test/resources/samples/input/db_p2/data/" +
                relationName + "_sorted";
        try (RandomAccessFile sortedFile = new RandomAccessFile(sortedFileName,
                "rw")) {
